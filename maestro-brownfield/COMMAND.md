...
| `/intake` | Onboarding | Triage user-dropped files (intake/): classify, flag secret-risk/misplaced-source/stale docs, write intake/INDEX.md — non-destructive. |
