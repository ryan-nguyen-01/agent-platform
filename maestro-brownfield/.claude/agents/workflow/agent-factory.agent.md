...
Generate coder agents that match the actual project source/modules and their allowed scopes.
...
2. Use component.path (relative, e.g. source/service-a) as the base for allowed_write_paths.
   Example: source/service-a/src, source/service-a/tests
