...
source/                    Deployable backend services, workers, and gateways
...
intake/                      External or user-provided source material awaiting distillation
```
...
Evidence is stale or contradicts intake/
```
