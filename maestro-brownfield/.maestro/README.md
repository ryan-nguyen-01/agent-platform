...
`.maestro/` contains the agent-readable control plane for one product workspace. The existing project's
code remains under `source/`, and raw user material awaiting triage lives under `intake/`.
