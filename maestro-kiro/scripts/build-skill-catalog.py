#!/usr/bin/env python3
"""Build a discoverability layer over the flat .kiro/skills/ collection.

Skills MUST stay physically flat (`.kiro/skills/<name>/SKILL.md`) for harness
...
def main() -> int:
    ...
    md = [
        ...
        "`.kiro/skills/<name>/SKILL.md`; this catalog is the discovery layer.",
        "",
