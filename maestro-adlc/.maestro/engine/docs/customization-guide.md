...
docs/            User-provided PRD/HLD/ADR/OpenAPI/glossary/runbooks
...
```text
1. Clone the service into app/<service-name>/
2. Run /onboard
...
```text
□ Clone maestro
□ Clone service repositories into app/<service-name>/
□ Put PRD/HLD/ADR/specs in docs/
